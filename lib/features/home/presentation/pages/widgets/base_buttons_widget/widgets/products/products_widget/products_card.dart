...
class ProductsCard extends StatefulWidget {
  const ProductsCard({required this.productsText, required this.onAdd, required this.onDelete, super.key});
...
class _ProductsCardState extends State<ProductsCard> {
  ...
  void initState() {
    super.initState();
    controller.text = widget.productsText;
  }
                  ...
                  GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: const Color(0xFFEF8249), width: 2.w),
                        color: isDone ? const Color(0xFFEF8249) : Colors.transparent,
                      ),
